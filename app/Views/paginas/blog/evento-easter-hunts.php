        ...
        <div class="row">
            <div class="col-lg-10">
                <div class="page-title">
                    ...
                    <h2 class="texto-blanco" data-animation="fadeInDown" data-delay=".4s">Easter Hunt 2026</h2>
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-7">
                <div class="blog-details-wrapper mb-40 wow fadeInUp">
                    <div class="blog-post-item">
                        ...
                        <div class="post-content">
                            <div id="informacion" class="entry-content">
                                <a href="https://buy.stripe.com/9B67sLc1bgzW7yQ8HI9k401" target="_blank" class="cat-btn">Evento Caza de Pascua</a>
                                <h2 class="title">Easter Hunt </h2>
                                <div class="post-meta">
                                    <ul>
                                        <li><span><i class="far fa-calendar-alt"></i><a href="https://buy.stripe.com/9B67sLc1bgzW7yQ8HI9k401" target="_blank"> 21-22 y 28-29 de marzo, 4-5 de abril
                                        </a></span></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <p>Easter Hunt <strong>(búsqueda de huevos de Pascua)</strong> es una actividad tradicional y divertida ideal para niños que realizamos en JD Dominican Farm durante
                             ...
                             <p><a href="https://buy.stripe.com/9B67sLc1bgzW7yQ8HI9k401" target="_blank"><strong>Reserva tu lugar ahora</strong></a> y no te pierdas esta increíble experiencia en familia.
                    ...
                    <a href="https://buy.stripe.com/9B67sLc1bgzW7yQ8HI9k401" target="_blank"
                    class="main-btn bordered-btn bordered-yellow">Entradas Easter Hunt</a></div> </p>  
                        </div>
